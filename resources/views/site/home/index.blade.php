                ...
                <div class="engloba-slider slider_principal">
                    ...
                    <ol class="carousel-indicators">
                      ...
                      <a class="left carousel-control" href="#carousel-example-generic" role="button" data-slide="prev">
                        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"><img src="{{ asset('assets/svg/arrow.svg')}}" alt="flecha direita" class="img-responsive"></span>
                        <span class="sr-only">Previous</span>
                      </a>
                      <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
                        <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"><img src="{{ asset('assets/svg/arrow.svg')}}" alt="flecha esquerda" class="img-responsive"></span>
