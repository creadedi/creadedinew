...
@section('conteudo')
  ...
  <div class="segura_info_tra_port">
    ...
    <img src="{{ asset('assets/images/trabalhos/bianchini_biodiesel/imagens_portfolio/imagem_port.jpg')}}">
    
    <div class="fundo_video_cor"></div>
<div class="titulo_sessao">
         
        <div class="texto_sessao">
        <h1>Video Institucional
</h1>
        </div>
...
>
    <div class="titulo_sessao_int azul">
      <div class="info_sessao">
        <span class="texto_medio">A Bianchini SA desenvolve um video contado a importância do Biodiesel e como isto ajuda no crescimento do pequeno agricultor.<br>
...
<section>
    ...
    <img src="{{ asset('assets/images/trabalhos/bianchini_biodiesel/imagens_portfolio/portfolio_foto_1.jpg')}}">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <img src="{{ asset('assets/images/trabalhos/bianchini_biodiesel/imagens_portfolio/portfolio_foto_2.jpg')}}">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <img src="{{ asset('assets/images/trabalhos/bianchini_biodiesel/imagens_portfolio/portfolio_foto_3.jpg')}}">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
   <div class="js-video [vimeo,widescreen]">
   <iframe src="https://player.vimeo.com/video/101766386" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
<p><a href="https://vimeo.com/101766386">biodiesel 07 25 14</a> from <a href="https://vimeo.com/user3352087">Prodv Comunica&ccedil;&atilde;o</a> on <a href="https://vimeo.com">Vimeo</a>.</p>
   </div>
    </div>
