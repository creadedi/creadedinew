...
@section('conteudo')
  ...
  <div class="segura_info_tra_port">
    ...
    <img src="{{ asset('assets/images/trabalhos/extrema_park_identidade_visual/imagens_portfolio/imagem_port.jpg')}}">
    
    <div class="fundo_video_cor"></div>
<div class="titulo_sessao">
         
        <div class="texto_sessao">
        <h1>Extrema Business Park
</h1>
        </div>
...
>
    <div class="titulo_sessao_int azul">
      <div class="info_sessao">
        <span class="texto_medio">Para a Extrema Business Park
...
<section>
    ...
    <img src="{{ asset('assets/images/trabalhos/extrema_park_identidade_visual/imagens_portfolio/portfolio_foto_central.jpg')}}">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <img src="{{ asset('assets/images/trabalhos/extrema_park_identidade_visual/imagens_portfolio/portfolio_foto_1.jpg')}}">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <img src="{{ asset('assets/images/trabalhos/extrema_park_identidade_visual/imagens_portfolio/portfolio_foto_2.jpg')}}">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <img src="{{ asset('assets/images/trabalhos/extrema_park_identidade_visual/imagens_portfolio/portfolio_foto_3.jpg')}}">
    </div>
    
    
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <img src="{{ asset('assets/images/trabalhos/extrema_park_identidade_visual/imagens_portfolio/portfolio_foto_4.jpg')}}">
    </div>
    
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <img src="{{ asset('assets/images/trabalhos/extrema_park_identidade_visual/imagens_portfolio/portfolio_foto_5.jpg')}}">
    </div>
