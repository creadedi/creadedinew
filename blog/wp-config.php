...
/** O nome do banco de dados do WordPress */
 //Added by WP-Cache Manager
define( 'WPCACHEHOME', '/home/creadedi/public_html/blog/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'creadedi_blog');

/** Usuário do banco de dados MySQL */
define('DB_USER', 'creadedi_silver');

/** Senha do banco de dados MySQL */
define('DB_PASSWORD', 'kid912082');
